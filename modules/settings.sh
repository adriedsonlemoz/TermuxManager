...
menu_configuracoes() {
    while true; do
        menu_unificado "🧰 Configurações" "Preferências do Manager" "[0] Voltar  •  [1–12] Selecionar"             "1|🎨|Aparência|Cores, descrições e ícones"             "2|📂|Pastas e caminhos|Painel, projetos e Downloads"             "3|📦|Importação|Exclusões, destino e conflitos"             "4|🚀|Execução de projetos|Navegador, porta e logs"             "5|🧹|Exclusões e limpeza|Temporários e logs"             "6|🔔|Comportamento|Inicialização e confirmações"             "7|🐟|Fish Shell|Instalar e configurar"             "8|🔄|Restaurar padrões|Não apaga projetos"             "9|🩺|Central de Diagnóstico|Manager, projetos e Termux"             "10|🧹|Limpeza do Painel|Projetos e arquivos do Painel"             "11|🛠️|Manutenção do Manager|Restaurar ou desinstalar"             "12|⚡|Atalhos do Manager|Comandos manager e mm"
        ler_opcao
        case "$RESPOSTA_MENU" in
